...
SonicI2C = sonic_sensor_ns.class_(
    "SonicI2C", sensor2.Sensor, i2c.I2CDevice, cg.PollingComponent
)
...
CONFIG_SCHEMA = (
    ...
    .extend(
        cv.polling_component_schema("60s").extend(i2c.i2c_device_schema(CONF_I2C_ADDR))
    )
)
